                ...
                <ul className="formations-list">
                    ...
                    <li className="second">
                        <div>
                            ...
                            <p>Formation en téléprésentiel. Les technologies que je vais acquérir durant cette formation sont React en TypeScript, node.js, Docker et NoSQL
                    ...
                    <li className="third">
                        <div>
                            ...
                            <p>De mon côté, je suis en train d'apprendre node.js en suivant une formation de <a className="link" href="https://grafikart.fr/tutoriels/javascript-server-nodejs-2080" target="_blank"> Grafikart</a>. L'objectif est de pouvoir m'amuser avec ce langage et monter des projets avec un ami développeur React. Ensuite, j'ai envie d'apprendre ce framework afin d'être à l'aise en front tout comme en back et de pouvoir jongler sur les deux tableaux.</p>
                        </div>
                    </li>
                </ul >
            </div >
