                ...
                <div className="row">
                    ...
                    <div className="resume">
                        <p>
                            ...
                            <br /> Durant cette première expérience, je me suis davantage orienté back-end en apprenant le framework Symfony. Le détail des langages étudiés durant cette formation et celle à venir est presenté <a class="link" href="#formations">ci-dessous</a>. À l'avenir, j'aspire à décortiquer JavaScript de tous les côtés et devenir développeur MERN.
                            <br />
