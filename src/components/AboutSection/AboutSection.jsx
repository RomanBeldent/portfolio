            ...
            <div className="content">
                ...
                <div className="row">
                    ...
                    <div className="resume">
                        <p>
                            Après 8 ans dans l'audiovisuel (monteur son & bruiteur), j'ai décidé de me reconvertir dans le développement WEB avec <a className="link" href="https://www.wildcodeschool.com/fr-fr/formations-developpement-web/formation-developpeur-web-alternance" target="_blank">O'Clock</a>.
